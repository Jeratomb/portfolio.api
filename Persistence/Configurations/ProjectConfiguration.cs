...
namespace portfolio.api.Persistence.Configurations
{
    public class ProjectConfiguration : IEntityTypeConfiguration<Project>
    {
        public void Configure(EntityTypeBuilder<Project> builder)
        {
            ...
            builder.HasMany(a => a.Knowledges).WithOne(b => b.Project).HasForeignKey(c => c.Id);
            builder.HasIndex(b => new{b.Name, b.KnowledgeId}).IsUnique();
            builder.HasAudits();

            builder.HasData(new { Id = new Guid("072c5d14-24e9-497b-a46c-26a29d9348e8"), KnowledgeId = new Guid("072c5d14-24e9-497b-a46c-26a29d9348e8"), Name = "Project 1", Description = "Test Project with css and html" , Created = DateTime.UtcNow });
            builder.HasData(new { Id = new Guid("195a2c50-1490-4982-a757-3cf882c46fea"), KnowledgeId = new Guid("072c5d14-24e9-497b-a46c-26a29d9348e8"), Name = "Project 2", Description = "Test Project 2 description 2", Created = DateTime.UtcNow});
